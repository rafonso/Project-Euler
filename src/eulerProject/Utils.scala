...
//    def sum(values : Iterable[Int], initialValue : Int = 0)(f : Int => Int) : Int = values.foldLeft(initialValue)(_ + f(_))
//
    def sum(values : Iterable[Long], initialValue : Long = 0L)(f : Long => Long) : Long = values.foldLeft(initialValue)(_ + f(_))

    def main(args : Array[String]) : Unit = {
    	
//        log(sum(1 to 100)(i => i * i))
    }
